...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210220040814_CreateDefinition')
BEGIN
...
BEGIN
    ...
    VALUES (N'20210220040814_CreateDefinition', N'5.0.3');
END;
GO
